                                                    ...
                                                    <td style="border:1px #000000 solid;">
                                                        <table cellpadding="0" cellspacing="0" border="0"  style="width:100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="76%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;"><strong>Ref. No. REC/Saubhagya/CC/Grievances/2018-19/Sl. No. </strong></td>
                                            ...
                                            <table cellpadding="0" cellspacing="0"  width="100%">
                                                <tr>
                                                    <td style="font-size:13px; line-height:19px; font-family:Arial, Helvetica, sans-serif;" valign="top"><strong>To<br/>
                                                        ...
                                                        <?= isset($params['discomName']) ? $params['discomName'] : '-'; ?> </td>
                                                </tr>
                                                <tr>
                                                    <td height="15"><img src="http://demodevelopment.com/security-mailer/spacer-img.png" alt="" width="5" height="15"  border="0" style="display: block;" /></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="right" valign="top" style="font-size:12px; line-height:18px; font-family:Arial, Helvetica, sans-serif;"> <strong style="color:#000; font-size:12px; line-height:18px; font-family:Arial, Helvetica, sans-serif;">Yours faithfully,</strong><br/> 
                                                        <span style="color:#333; font-size:12px; line-height:18px; font-family:Arial, Helvetica, sans-serif;"> (Ajay Kumar Gupta)<br/>
                                                            Addl. GM (CC)<br/>
                                                            REC Control Centre<br/>
                                                            Email:  <a href="mailto:akgupta@recl.in" style="color:#06F; text-decoration:underline !important;">akgupta@recl.in</a><br/>
                                                            011-43620303(O) and 9899466617(M)</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="40"><img src="http://demodevelopment.com/security-mailer/spacer-img.png" alt="" width="5" height="40"  border="0" style="display: block;" /></td>
                                                    ...
                                                    <td valign="top">
                                                        <table cellpadding="0" cellspacing="0"  width="800" style="font-size:12px; line-height:18px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-size:12px; line-height:18px; font-family:Arial, Helvetica, sans-serif;" valign="top" width="585">The Addl Chief Secretary/Principal Secretary/Secretary, Address for kind information.</td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-size:12px; line-height:18px; font-family:Arial, Helvetica, sans-serif;" valign="top" width="15"><strong>4.</strong></td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellpadding="2" cellspacing="2" border="1"  width="800" style="font-size:12px; line-height:18px;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" valign="top" width="50" style="padding:2px; border-bottom:1px #ccc solid;">1</td>
                                                                    <td align="left" valign="top" width="200" style="padding:2px;  border-bottom:1px #ccc solid;  border-left:1px #ccc solid;"><?= $params['grievanceNo']; ?></td>
                                                                    <td align="left" valign="top"  width="150" style="padding:2px; border-bottom:1px #ccc solid;  border-left:1px #ccc solid;"><?= $params['name']; ?></td>
                                                                    <td align="left" valign="top" width="200" style="padding:2px; border-bottom:1px #ccc solid;  border-left:1px #ccc solid;"><?= 'State' . $params['state'] . '/' . $params['district']; ?> </td>
                                                                    <td align="left" valign="top" width="100" style="padding:2px; border-bottom:1px #ccc solid;  border-left:1px #ccc solid;"><?= $params['type']; ?></td>
                                                                    <td align="left" valign="top" width="50" style="padding:2px; border-bottom:1px #ccc solid;  border-left:1px #ccc solid;"><?= $params['status']; ?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
