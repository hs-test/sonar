                                            ...
                                            <table cellpadding="0" cellspacing="0"  width="100%">
                                                ...
                                                <tr>
                                                    <td valign="top" style="font-size:13px; line-height:19px;  font-family:Arial, Helvetica, sans-serif;"><strong>Sir/Madam,</strong><br/>
                                                        This is to inform that grievance of consumer <?= isset($params['prefix']) ? $params['prefix'] : '-'; ?> <?= $params['name']; ?>R/O
                                                        village <?= $params['village']; ?> District <?= $params['district']; ?> State <?= $params['state']; ?> vide Regn. No. <?= $params['grievanceNo']; ?> for release of electricity connection under Saubhagya has
                                                        been reopened after verification of consumer's grievance still pending unresolved and the
                                                        status of the same has been uploaded on REC Control Centre Web Portal for its resolution
                                                        by State Discom.
                                                        It is therefore requested to take immediate action for release of electricity connection in
                                                        consumer's household premises under Saubhagya and update the status on REC Control
                                                        Centre Web Portal.</td>
                                                </tr>
                                                <tr>
                                                    <td height="15"><img src="http://demodevelopment.com/security-mailer/spacer-img.png" alt="" width="5" height="15"  border="0" style="display: block;" /></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="right" valign="top" style="font-size:12px; line-height:18px; font-family:Arial, Helvetica, sans-serif;"> <strong style="color:#000">Thanking You</strong><br/> 
                                                        <span style="color:#333;">

                                                            REC Control Centre Exective<br/>
                                                            Toll Free No. 1800-121-5555<br/>
                                                            Email:  <a href="mailto:reccontrolroom@gmail.com" style="color:#06F; text-decoration:underline !important;">reccontrolroom@gmail.com</a><br/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
