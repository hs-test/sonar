...
$this->title = "SRN Depository Import";
...
switch ($actionid) {
    case "cdsl-import":
        $cdsl = TRUE;
        $formatUrl = \Yii::$app->params['staticHttpPath'] . '/dist/deploy/format/cdsl_format.csv';
        $viewLogsurl = yii\helpers\Url::toRoute(['grievance/import-depository-logs', 'type' => common\models\GrievanceStat::TYPE_CDSL]);
        break;
    case "nsdl-import":
        $nsdl = TRUE;
        $formatUrl = \Yii::$app->params['staticHttpPath'] . '/dist/deploy/format/nsdl_format.csv';
        $viewLogsurl = yii\helpers\Url::toRoute(['grievance/import-depository-logs', 'type' => common\models\GrievanceStat::TYPE_NSDL]);
        break;
    case "amount-import":
        $amount = TRUE;
        $formatUrl = \Yii::$app->params['staticHttpPath'] . '/dist/deploy/format/amount_format.csv';
        $viewLogsurl = yii\helpers\Url::toRoute(['grievance/import-depository-logs', 'type' => common\models\GrievanceStat::TYPE_AMOUNT]);
        break;
}
?>
<?= $this->registerJs('GrievanceController.import();'); ?>
<?= $this->render('partials/_import-sub-menu.php', ['amount' => $amount, 'nsdl' => $nsdl, 'cdsl' => $cdsl]) ?>
                                        ...
                                        <div class="section-head__optionSets">
                                            <div class="section-head__optionSets--filter"><div class="top_buttonWrap">
                                                    ...
                                                    <aside class="rightWrap">
                                                        <a class="addComment button blue" href="<?= $formatUrl; ?>" title="Download Format"><i class="fa fa-file-excel-o"></i>Download Format</a>
                                                        <a class="button green" href="<?= $viewLogsurl; ?>" title="View Logs"><i class="fa fa-eye"></i>View Logs</a>
                                                    </aside>
                                                </div>
                                            </div>
                                        </div>
