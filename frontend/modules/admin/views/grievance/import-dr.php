...
$this->title = "SRN DR Import";
?>
<?= $this->registerJs('GrievanceController.import();'); ?>
<?= $this->render('partials/_sub-menu.php', ['drimport' => TRUE]) ?>
                                        ...
                                        <div class="section-head__optionSets">
                                            <div class="section-head__optionSets--filter"><div class="top_buttonWrap">
                                                    ...
                                                    <aside class="rightWrap">
                                                        <a class="addComment button blue" href="<?=\Yii::$app->params['staticHttpPath'] . '/dist/deploy/format/dr_import_format.csv';?>" title="Download Format"><i class="fa fa-file-excel-o"></i>Download Format</a>
                                                        <a class="button green" href="<?=  yii\helpers\Url::toRoute(['grievance/import-logs','type'=>  common\models\GrievanceStat::TYPE_DR])?>" title="View Logs"><i class="fa fa-eye"></i>View Logs</a>
                                                    </aside>
                                                </div>
                                            </div>
                                        </div>
