...
?>
<?= $this->render('partials/_sub-menu.php', ['executive' => TRUE]) ?>
                                ...
                                <div class="section-head">
                                    ...
                                    <div class="section-head__optionSets">
                                        ...
                                        <div class="section-head__optionSets--addButton">
                                            <a class="export" href="<?= Url::toRoute(['report/executive']) ?>">Export</a>
                                        </div>
                                    </div>
                                </div>
                                <?=
...
//                                                        return isset($model['date'])  ? date('d-m-Y',$model['date'])  : 'N/A';
//                                                }
//                                            ],
                                            ...
                                            [
                                                ...
                                                'filter' => false,
                                                'label' => 'No of Grievance Attended',
                                                'sortLinkOptions' => ['class' => 'sort'],
                                            ],
                                            [
                                                'attribute' => 'resolved',
                                                'filter' => false,
                                                'label' => 'No of Grievance Resolved',
                                                'sortLinkOptions' => ['class' => 'sort'],
                                            ],
                                            [
                                                'attribute' => 'ongoing',
                                                'filter' => false,
                                                'label' => 'No of Grievance Ongoing',
                                                'sortLinkOptions' => ['class' => 'sort'],
                                            ],
                                            [
                                                'attribute' => 'pending',
                                                'filter' => false,
                                                'label' => 'No of Grievance Pending',
                                                'sortLinkOptions' => ['class' => 'sort'],
                                            ],
