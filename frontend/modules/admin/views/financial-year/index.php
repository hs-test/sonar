...
$this->title = 'Financial Year';
$this->params['breadcrumbs'][] = ['label' => \Yii::t('admin', 'Financial Year')];
$this->registerJs('FinancialYearController.createUpdate();');
?>
                                ...
                                <div class="section-head">
                                    ...
                                    <div class="section-head__optionSets">
                                        ...
                                        <div class="section-head__optionSets--addButton">
                                            <a href="<?= Url::toRoute(['create']) ?>"><i class="fa fa-plus"></i> New</a>
                                        </div>
                                    </div>
                                </div>
                                <?= $this->render('/financial-year/partials/_filter-form.php', ['model' => $searchModel]) ?>
                            </div>
                            <?php
                            Pjax::begin(['id' => 'fianancialyearDataList']);
                                                ...
                                                'buttons' => [
                                                    ...
                                                    'delete' => function ($url, $model, $key) {
                                                        return Html::a('<i class="fa fa-trash"></i>', 'javascript:;', [
                                                                    ...
                                                                    'class' => 'delete deletefinancialyear',
                                                        ]);
                                                    },
                                                ],
                                                'headerOptions' => [
