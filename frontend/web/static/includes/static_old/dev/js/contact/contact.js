var ContactController = (function ($) {
    return {
        summary: function () {
            ContactController.Summary.init();
        },
		createUpdate: function () {
            ContactController.CreateUpdate.init();
        },
...
ContactController.Summary = (function ($) {
    ...
    var deleteRecord = function () {
        $('.deleteContactRecord').on('click', function (e) {
            e.preventDefault();
            var elem = $(this);
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result === true) {
                        ...
                        ContactController.sendAjaxRequest(elem, params);
                    }
                }
            });
        });
    ...
    var updateStatus = function (e) {
        $('.updateContactStatus').on('click', function (e) {
            e.preventDefault();
            var elem = $(this);
            var url = elem.data('url');
            if (typeof url === 'undefined' || url === '') {
...
ContactController.CreateUpdate = (function ($) {
    var attachEvents = function () {
    };
