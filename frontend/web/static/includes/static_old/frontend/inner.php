          ...
          <div class="action__form">
            <div class="action__form-main">
              <form>
                ...
                <button href="about-digital-village.php" class="button theme__btn">Submit Now</button>
              </form>
            </div>
...
<p><img src="static/images/content-images/about-img.png" width="555" height="332" class="img-fluid" /></p>
