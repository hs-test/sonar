...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.core.api.Main", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.api.Tinymce", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.Register", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.geom.Rect", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Promise", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Delay", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.Env", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.EventUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.Sizzle", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Tools", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.DomQuery", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.Styles", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.TreeWalker", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.Entities", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.DOMUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.ScriptLoader", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.AddOnManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.RangeUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.Node", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.Schema", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.SaxParser", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.DomParser", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.Writer", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.html.Serializer", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.Serializer", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.VK", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.ControlSelection", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.BookmarkManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.Selection", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.Formatter", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.UndoManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.EditorCommands", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.URI", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Class", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.EventDispatcher", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Observable", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.WindowManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.NotificationManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.EditorObservable", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.Shortcuts", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.Editor", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.I18n", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.FocusManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.EditorManager", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.XHR", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.JSON", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.JSONRequest", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.JSONP", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.LocalStorage", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.api.Compat", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Color", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Api", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Arr", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.Range", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.StyleSheetLoader", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.NodeType", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretContainer", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.text.Zwsp", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretBookmark", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretPosition", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.TridentSelection", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.ElementUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Fun", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.fmt.Preview", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.fmt.Hooks", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.undo.Levels", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.InsertContent", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Window", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.MessageBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Notification", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.NodeChange", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.KeyboardOverrides", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ForceBlocks", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Quirks", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.Mode", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.EditorUpload", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.SelectionOverrides", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.Uuid", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Sidebar", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ErrorReporter", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.LegacyInput", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Selector", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Collection", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ReflowQueue", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Control", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Factory", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.KeyboardNavigation", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Container", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.DragHelper", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Scrollable", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Panel", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Movable", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Resizable", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FloatPanel", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Tooltip", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Widget", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Progress", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Layout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.AbsoluteLayout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Button", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ButtonGroup", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Checkbox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ComboBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ColorBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.PanelButton", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ColorButton", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ColorPicker", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Path", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ElementPath", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FormItem", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Form", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FieldSet", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FilePicker", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FitLayout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FlexLayout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FlowLayout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.FormatControls", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.GridLayout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Iframe", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.InfoBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Label", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Toolbar", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.MenuBar", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.MenuButton", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.MenuItem", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Throbber", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Menu", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ListBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Radio", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ResizeHandle", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.SelectBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Slider", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.Spacer", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.SplitButton", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.StackLayout", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.TabPanel", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.TextBox", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretCandidate", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.geom.ClientRect", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.text.ExtendingChar", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.undo.Fragments", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretWalker", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.InsertList", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.data.ObservableObject", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.DomUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.BoxUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.ui.ClassList", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.ArrowKeys", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.DeleteBackspaceKeys", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.EnterKey", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.NodePath", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.file.Uploader", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.file.ImageScanner", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.file.BlobCache", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.file.UploadStatus", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretContainerRemove", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.FakeCaret", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.LineWalker", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.LineUtils", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.DragDropOverrides", ".", mapper.constant("tinymce")),
      source("bolt", "global!window", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.content.LinkTargets", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.fmt.FontInfo", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.undo.Diff", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.data.Binding", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Cell", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.BoundarySelection", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.MatchKeys", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.BoundaryDelete", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.file.Conversions", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Arr", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.Dimensions", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.dom.MousePosition", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Option", ".", mapper.constant("tinymce")),
      source("bolt", "global!Array", ".", mapper.constant("tinymce")),
      source("bolt", "global!Error", ".", mapper.constant("tinymce")),
      source("bolt", "global!String", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Fun", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.BoundaryLocation", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.BoundaryCaret", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.keyboard.InlineUtils", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Merger", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Options", ".", mapper.constant("tinymce")),
      source("bolt", "global!Object", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Adt", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.text.Bidi", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.util.LazyEvaluator", ".", mapper.constant("tinymce")),
      source("bolt", "tinymce.core.caret.CaretContainerInline", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Type", ".", mapper.constant("tinymce")),
      source("bolt", "ephox.katamari.api.Obj", ".", mapper.constant("tinymce")),
      source("bolt", "global!console", ".", mapper.constant("tinymce"))
    ]
  });
