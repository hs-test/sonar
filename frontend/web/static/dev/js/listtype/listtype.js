 ...
 */
var ListTypeController = (function($) {
     return {
        createUpdate: function () {
            ListTypeController.CreateUpdate.init();
        }
    };
}(jQuery));

ListTypeController.CreateUpdate = (function ($) {
                    ...
                    if (result === true) {
                        ...
                        success: function (data, textStatus, jqXHR) {
                            if(data.success == "1") {
                                ...
                                $.pjax.reload({container: '#listtypeDataList', timeout:false});
                            }
                        },
